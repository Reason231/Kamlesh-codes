...
import { RoleSelector } from "../../../components/common/form/input.component";
...
const RegisterPage = () => {
  ...
  const submitEvent=async(data:any)=>{
    setLoading(true)
      try{
        ...
        toast.success(response.message)  // It gives popup of user created
        toast.success("Please check your email for the activation of your account in order to procced for the login")
        navigate("/")
      }
  ...
  return (
    <>
      {/* It re-directs to the login page after clicking the signup button */}
              ...
              <form onSubmit={handleSubmit(submitEvent)} className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6">
                  ...
                  <TextInputComponent
                    ...
                    control={control}
                    msg={errors?.email?.message}   // it gives the error Jaba hami lea name nahali kana submit garchau. 
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <TextInputComponent
                    name="confirmPassword"  // should be same as backend validation
                    type={INPUT_TYPE.PASSWORD}
                    control={control}
                  />
                </div>
                ...
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    onChange={(e: any) => {
                      ...
                      // Object.values(e.target.files) => [{File}]   It is used for multiple files
                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  <button
                    type="submit"
                    className="inline-block shrink-0 rounded-md disabled:cursor-not-allowed border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500"
                    disabled={loading}
                  >
                    Create an account
                  </button>
